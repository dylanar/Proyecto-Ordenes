...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "Ordenes", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("1", "Estadisticas", Model_Menu.MenuType.MENU));
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#003e58"), 0, getHeight(), Color.decode("#0097ff"));
        g2.setPaint(g);
